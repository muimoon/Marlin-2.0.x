 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 93, 382.166}  //92.6
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -10, 0} //defualt is 10,10,0
...
#define Z_HOMING_HEIGHT  4     // 4(mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
 ...
 * :[0:'Classic', 1:'Průša']
 */
//#define LCD_INFO_SCREEN_STYLE 10
